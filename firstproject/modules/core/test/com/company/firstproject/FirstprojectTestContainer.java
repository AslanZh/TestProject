...
public class FirstprojectTestContainer extends TestContainer {

    public FirstprojectTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/firstproject/app.properties",
    ...
    public static class Common extends FirstprojectTestContainer {

        public static final FirstprojectTestContainer.Common INSTANCE = new FirstprojectTestContainer.Common();
